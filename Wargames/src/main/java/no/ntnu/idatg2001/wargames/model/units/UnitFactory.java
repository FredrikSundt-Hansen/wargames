...
public class UnitFactory {
  ...
  /**
   * Private constructor restricting object creation, making constructor only available when used
   * with getInstance.
   */
  private UnitFactory() {}
  ...
  /**
   * Method to create a single Unit, based on unitType input. Passes the name and health to the new
   * object.
   *
